            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index.php" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="../images/ndx_primary_logo_color%402x.png" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="../images/ndx_primary_logo_color%402x.png" alt="" height="17">
                        </span>
                    </a>

                    <a href="index.php" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="../images/ndx_primary_logo_color%402x.png" alt="" height="60">
                            <h4><?php echo $name ?></h4>
                        </span>
                        <span class="logo-lg">
                            <img src="../images/ndx_primary_logo_color%402x.png" alt="" height="60">
